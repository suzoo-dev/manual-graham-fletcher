...
const paragraphText = (): ReactElement => (
  <p className={`mb-8 text-lg leading-8 text-primary font-medium`}>
      ...
      {!showQuiz ? (
        <div>
          ...
          >
            <div className="flex flex-row w-full justify-around">
              <div className="flex flex-col w-[468px]">
                ...
                <h1 className={`mb-8 text-8xl text-primary font-medium`}>
                  Be good to yourself
                </h1>
                {paragraphText()}
                <div>
          ...
          <div className="flex flex-col w-full">
            <h1
              className={`flex items-center text-center justify-center text-4xl text-primary h-16 w-full mt-16 mb-16 font-medium`}
            >
            ...
            <div className="flex flex-row justify-around mb-20">
              ...
              <div className="flex flex-col justify-center w-[372px] mr-28">
                <h4 className={`text-xs leading-10 font-medium`}>HAIR LOSS</h4>
                <h2
            ...
            <div className="flex flex-row justify-around mb-20">
              <div className="flex flex-col justify-center w-[372px] ml-28">
                <h4 className={`text-xs leading-10 font-medium`}>
            ...
            >
              ...
              <div>
                <h4 className={`text-sm text-primary mb-4 font-medium`}>
                  Product
                </h4>
